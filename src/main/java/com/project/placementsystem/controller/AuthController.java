...
import com.project.placementsystem.dto.AuthRequestDTO;
import com.project.placementsystem.security.JwtUtil;
import com.project.placementsystem.service.UserService;
...
public class AuthController 
{
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequestDTO request) 
    {
        try 
        {
            ...
            else if (role.equalsIgnoreCase("STUDENT") || role.equalsIgnoreCase("EMPLOYER") || role.equalsIgnoreCase("PLACEMENT OFFICER"))
            {
