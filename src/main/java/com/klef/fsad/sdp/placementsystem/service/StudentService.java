...
public interface StudentService {
	...
	public String studentRegistration(String name, String email, String password,String branch, float cgpa, int year,
			String username, String collegeName, String contact,MultipartFile file);
